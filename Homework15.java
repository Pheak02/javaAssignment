        ...
        for (int i = 0; i < array2D.length; i++) {
            for (int j = 0; j < array2D[i].length; j++) {
                ...
                if (i + 3 < array2D.length) {
                    if (array2D[i][j] == array2D[i + 1][j] && array2D[i + 1][j] == array2D[i + 2][j] && array2D[i + 2][j] == array2D[i + 3][j]) {
                        return true;
                    }
                }
                if (i + 3 < array2D.length && j - 3 >= 0) {
                    if (array2D[i][j] == array2D[i + 1][j - 1] && array2D[i + 1][j - 1] == array2D[i + 2][j - 2] && array2D[i + 2][j - 2] == array2D[i + 3][j + 3]) {
                        return true;
                    }
                }
